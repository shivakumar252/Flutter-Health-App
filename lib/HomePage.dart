  ...
  void calculateBMI() {
    ...
    setState(() {
      ...
      if (this.bmi < 18.50) {
        ...
        this.image =
            "https://media.tenor.com/images/d74a3e642b19d4abd37dae6f0e8ce5a4/tenor.gif";
      } else if (this.bmi >= 18.50 && this.bmi <= 24.99) {
        this.bmiStatus = "Healthy Weight";
        this.image =
            "https://i.pinimg.com/originals/e3/d0/86/e3d086800546d84d641102cba6fd084a.gif";
                        ...
                        RaisedButton(
                          onPressed: () => {
                            Scaffold.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  "this is Your BMI ststus,For better results Please Book a Health Session",
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold),
                                ),
