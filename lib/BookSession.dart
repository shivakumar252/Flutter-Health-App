...
class _BookSessionState extends State<BookSession> {
  ...
  void detailsPage(imageSrc) {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => DetailsPage(imageSrc)));
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Image.network(
              "https://content1.getnarrativeapp.com/68f6039f-a2f9-4e15-9b91-4f7cebe2a378/img_ref/3bd566cf-39ff-45fd-bc66-7cbe071da05f/Kim%20B%20-117_professional_yoga_photographer_photos_photography_750.jpg"),
          RaisedButton(
              color: Color(0xFFEB1555),
            onPressed: () {
              detailsPage(
          ...
          Image.network(
              "https://i.pinimg.com/originals/c5/01/8c/c5018c083f2ab4e94d353253db4a3439.gif"),
          RaisedButton(
              color: Color(0xFFEB1555),
            onPressed: () {
              detailsPage(
